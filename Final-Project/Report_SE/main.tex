...
\subsubsection{End-to-End Tests with Cucumber}

\paragraph{Purpose and Rationale}
...
\paragraph{Implemented Feature Files}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{stress_tests_results/tests-plan.png}
...
\paragraph{Stress Testing the Business Logic Backend}
...
\subparagraph{Average Response Time}
...
\end{figure}
\subparagraph{Minimum and Maximum Response Times}
